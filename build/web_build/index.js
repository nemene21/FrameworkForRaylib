...
(() => {
  ...
  function loadPackage(metadata) {
    ...
    function runWithFS() {
      ...
      Module["FS_createPath"]("/assets/images", "post_processing", true, true);
      Module["FS_createPath"]("/assets", "particles", true, true);
  ...
  loadPackage({
    "files": [ {
      "filename": "/assets/images/post_processing/noise.png",
      "start": 0,
      "end": 293167
    }, {
      "filename": "/assets/images/post_processing/paper.png",
      "start": 293167,
      "end": 2328625
    }, {
      ...
      "filename": "/assets/particles/jump.json",
      "start": 2329019,
      "end": 2329691
    }, {
      "filename": "/assets/particles/move.json",
      "start": 2329691,
      "end": 2330385
    }, {
      "filename": "/assets/particles/pop.json",
      "start": 2330385,
      "end": 2331080
    }, {
      "filename": "/assets/particles/test.json",
      "start": 2331080,
      "end": 2331750
    }, {
      "filename": "/assets/sfx/shoot4.mp3",
      "start": 2331750,
      "end": 2338534,
      "audio": 1
    }, {
      ...
      "filename": "/assets/shaders/post_processing.glsl",
      "start": 2338728,
      "end": 2340653
    }, {
      "filename": "/assets/tracks/1.wav",
      "start": 2340653,
      "end": 11310937,
      "audio": 1
    }, {
      "filename": "/assets/tracks/2.wav",
      "start": 11310937,
      "end": 20281221,
      "audio": 1
    } ],
    "remote_package_size": 20281221
  });
})();
...
var ASM_CONSTS = {
  ...
  81398: () => document.getElementById("canvas").width,
  81450: () => parseInt(document.getElementById("canvas").style.width),
  81518: () => {
  ...
  81664: () => document.getElementById("canvas").width,
  81716: () => screen.width,
  81741: () => {
    document.exitFullscreen();
  },
  ...
  81947: () => document.getElementById("canvas").width,
  81999: () => parseInt(document.getElementById("canvas").style.width),
  82067: () => {
    if (document.fullscreenElement) return 1;
  },
  82113: () => document.getElementById("canvas").width,
  82165: () => screen.width,
  82190: () => {
    if (document.fullscreenElement) return 1;
  },
  82236: () => document.getElementById("canvas").width,
  82288: () => screen.width,
  82313: () => {
    document.exitFullscreen();
  },
  ...
  82386: () => document.getElementById("canvas").width,
  82438: () => parseInt(document.getElementById("canvas").style.width),
  82506: () => {
    document.exitFullscreen();
  },
  82533: () => screen.width,
  82558: () => screen.height,
  82584: () => window.screenX,
  82611: () => window.screenY,
  82638: $0 => {
  ...
  85305: () => (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined),
  85409: () => {
    try {
  ...
  88408: $0 => miniaudio.get_device_by_index($0).webaudio.sampleRate,
  88474: $0 => {
